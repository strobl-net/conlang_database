use crate::models::{NewScript as NewModel, Script, UpdateScript as UpdateModel};
use crate::queries::ScriptQuery as QueryModel;
use crate::schema::scripts as model;
use crate::schema::scripts::dsl::scripts as query;
use diesel::prelude::*;
